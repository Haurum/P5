...
\contentsline {lstlisting}{\numberline {B.3}Receiving data from the computer}{49}{lstlisting.B.3}
\contentsline {lstlisting}{\numberline {B.4}The defined and declared variables}{50}{lstlisting.B.4}
\contentsline {lstlisting}{\numberline {B.5}The setup function}{50}{lstlisting.B.5}
